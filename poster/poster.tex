...
%  background=shade-tb,
  ...
  {% Title
    \maketitle
    %{\sf \VERYLarge \color{white} \bf{Learning about the Attention Mechanism and the Transformer model}}
  }
  {% Authors
   ...
   %	\vspace{-0.3em }
	...
	%{\color{white} \large\underline{Spring 19 -- CS 7643 Deep Learning -- Prof. Zsolt Kira}}
  }
  { % University Logo
